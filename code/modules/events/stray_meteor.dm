...
/datum/round_event/stray_meteor/announce(fake)
	if(GLOB.meteor_list)
		...
		priority_announce("Сенсор [sensor_name] обнаружил входящую сигнатуру, приближающуюся к [GLOB.station_name]. Пожалуйста, приготовьтесь к столкновению.", "Meteor Alert")
