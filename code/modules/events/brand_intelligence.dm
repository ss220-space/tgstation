...
/datum/round_event/brand_intelligence/announce(fake)
	priority_announce("На боргу [station_name()] обнаружен агрессивный маркетинг. Пожалуйста, проверьте все вендоматы бренда [origin_machine] на предмет агрессивной маркетинговой тактики и при необходимости перезагрузите их.", "Machine Learning Alert")
