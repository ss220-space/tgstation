...
/datum/round_event/bureaucratic_error/announce(fake)
	priority_announce("Недавняя бюрократическая ошибка в департаменте органических ресурсов может привести к нехватке персонала в одних отделах и избыточному персоналу в других.", "Предупреждение об инциденте бумажной работы")
