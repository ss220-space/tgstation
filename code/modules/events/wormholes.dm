...
/datum/round_event/wormholes/announce(fake)
	priority_announce("Пространственно-временные аномалии обнаружены на станции. Дополнительные данные отсутствуют.", "Оповещение об аномалии", ANNOUNCER_SPANOMALIES)
