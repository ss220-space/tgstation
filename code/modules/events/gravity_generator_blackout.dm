...
/datum/round_event/gravity_generator_blackout/announce(fake)
	priority_announce("Гравносферные аномалии обнаружены вблизи [station_name()]. Требуется ручной перезапуск генератора гравитации.", "Anomaly Alert", ANNOUNCER_GRANOMALIES)
